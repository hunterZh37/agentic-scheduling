...
export async function GET(): Promise<NextResponse> {
  // Owner accounts only. Co-host calendars (coHostId set) are theirs alone — the
  // owner's Calendars manager must not list, or be able to see, a co-host's
  // connected addresses. This is the owner side of the co-host privacy wall.
