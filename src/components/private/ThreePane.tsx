...
import { CoHostsManager } from "@/components/cohosts/CoHostsManager";
...
function CalendarsLegend({
  ...
  return (
    <div className={styles.legend}>
      ...
      <button className={styles.coHosts} onClick={onCoHosts} title="Manage co-hosts">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <button className={styles.coHosts} onClick={onSettings} title="Booking settings">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <button className={styles.coHosts} onClick={onUsage} title="Token usage">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          <path d="M3 3v18h18" />
...
export function ThreePane() {
  ...
  return (
    <div className={styles.window} onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
      ...
      {coHostsOpen && <CoHostsManager onClose={() => setCoHostsOpen(false)} />}
      {settingsOpen && <SettingsManager onClose={() => setSettingsOpen(false)} />}
      {usageOpen && <TokenUsagePanel onClose={() => setUsageOpen(false)} />}
    </div>
  );
}
