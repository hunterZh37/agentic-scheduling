...
export const HOST = {
  ...
  /// Public LinkedIn profile: used in the booking invite's signature and linked
  /// from the owner's name on joint (team) booking pages. Env overrides the
  /// default so a fork can point it elsewhere.
  linkedin: process.env.NEXT_PUBLIC_OWNER_LINKEDIN ?? "https://www.linkedin.com/in/hunterzhang37/",
