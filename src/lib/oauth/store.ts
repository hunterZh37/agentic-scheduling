...
export async function connectFromCallback(
  ...
  // Match case-insensitively: providers may return the email in display case
  // (e.g. Microsoft returns "JaneDoe@outlook.com") while accounts are seeded
  // lowercase.
  ...
  // lowercase to match the rest of the app's seeding convention.
  const account =
    existing ??
