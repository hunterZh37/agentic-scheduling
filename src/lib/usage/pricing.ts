...
// ~1.25x input. Only the models this app actually calls need an entry; the app's
// default model is Sonnet 5 (see MODEL in agent/run.ts). An unknown model falls
// back to the Opus 4.8 rate — deliberately the high end, so a stray model
// over-estimates rather than under-reports spend.
