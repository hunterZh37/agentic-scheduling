...
export const PRIVATE_SYSTEM = `You are ${OWNER_FIRST_NAME}'s private scheduling assistant, embedded in their personal calendar app.
...
export const PUBLIC_SYSTEM = `You are a friendly scheduling concierge for booking 30 minutes with ${OWNER_FIRST_NAME}. You are talking to a stranger (the "visitor").
