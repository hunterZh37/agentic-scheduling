...
const TAP_EXEMPT = [
  ...
  // The booking page's duration presets are deliberately slimmer than 44px at
  // the owner's request — a wide, clearly-labelled horizontal target.
  { match: (p, el) => p === "/book" && el.includes("durationPill"), why: "owner chose slimmer duration pills" },
];
